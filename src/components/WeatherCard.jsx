...
function WeatherCard({weatherData}) {
    ...
    return (
        ...
        <section className="main__weatherCard">
            ...
            <p className="main__temperature">{weatherData?.main?.temp ?`${Math.round(weatherData.main.temp)}` : "Loading weather..."}&#8457;</p>
            <img src={`${banner}`} alt="weather banner" className="main__weatherCard-img" />
        </section>
    )
}
